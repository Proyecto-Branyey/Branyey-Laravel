                ...
                <form action="<?php echo e(route('tienda.catalogo')); ?>" method="GET">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="list-group list-group-flush rounded-3 overflow-hidden shadow-sm">
                            <label class="list-group-item list-group-item-action border-0 <?php echo e(!request('estilo_camisa_id') ? 'active bg-dark text-white' : ''); ?> cursor-pointer">
                                <input type="radio" name="estilo_camisa_id" value="" class="d-none" onchange="this.form.submit()" <?php echo e(!request('estilo_camisa_id') ? 'checked' : ''); ?>>
                                Todos los estilos
                            </label>
                            <?php $__currentLoopData = $estilos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estilo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="list-group-item list-group-item-action border-0 <?php echo e(request('estilo_camisa_id') == $estilo->id ? 'active bg-dark text-white' : ''); ?> cursor-pointer">
                                    <input type="radio" name="estilo_camisa_id" value="<?php echo e($estilo->id); ?>" class="d-none" onchange="this.form.submit()" <?php echo e(request('estilo_camisa_id') == $estilo->id ? 'checked' : ''); ?>>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="list-group list-group-flush rounded-3 overflow-hidden shadow-sm">
                            <label class="list-group-item list-group-item-action border-0 <?php echo e(!request('clasificacion_talla_id') ? 'active bg-dark text-white' : ''); ?> cursor-pointer">
                                <input type="radio" name="clasificacion_talla_id" value="" class="d-none" onchange="this.form.submit()" <?php echo e(!request('clasificacion_talla_id') ? 'checked' : ''); ?>>
                            ...
                            <?php $__currentLoopData = $clasificaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clasif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="list-group-item list-group-item-action border-0 <?php echo e(request('clasificacion_talla_id') == $clasif->id ? 'active bg-dark text-white' : ''); ?> cursor-pointer">
                                    <input type="radio" name="clasificacion_talla_id" value="<?php echo e($clasif->id); ?>" class="d-none" onchange="this.form.submit()" <?php echo e(request('clasificacion_talla_id') == $clasif->id ? 'checked' : ''); ?>>
                    ...
                    <?php if(request()->anyFilled(['estilo_camisa_id', 'clasificacion_talla_id'])): ?>
                        ...
                        <div class="card h-100 border-0 shadow-sm product-hover" style="border-radius: 20px; overflow: hidden;">
                            <div class="position-relative overflow-hidden" style="height: 380px; background-color: #f8f9fa;">
                                <a href="<?php echo e(route('tienda.producto.detalle', $producto->id)); ?>">
                                    ...
                                    <?php if($img): ?>
                                        <img src="<?php echo e(Storage::url($img->ruta)); ?>" class="w-100 h-100 img-zoom" style="object-fit: cover; object-position: top;" alt="<?php echo e($producto->nombre); ?>">
                                    <?php else: ?>
                            ...
                            <div class="card-body text-center">
                                ...
                                <h6 class="card-title fw-bold text-dark text-uppercase mb-3"><?php echo e($producto->nombre); ?></h6>
