...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="<?php echo e(route('admin.productos.papelera')); ?>" class="btn btn-outline-danger shadow-sm">
                <i class="bi bi-trash3 me-1"></i> Papelera Productos
            </a>
            <a href="<?php echo e(route('admin.variantes.papelera')); ?>" class="btn btn-outline-danger shadow-sm">
