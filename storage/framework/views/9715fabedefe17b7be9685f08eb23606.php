                ...
                <div class="category-card position-relative overflow-hidden rounded-xl shadow-sm hover-zoom">
                    ...
                    <div class="category-overlay d-flex align-items-end">
                        <div class="w-100 p-4 text-white">
                            ...
                            <a href="<?php echo e(route('tienda.catalogo')); ?>" class="btn btn-sm btn-light rounded-pill">Ver Más →</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 bg-light">
        <div class="container">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="product-card-enhanced h-100">
                            <div class="product-image-wrapper position-relative overflow-hidden rounded-xl">
                                ...
                                ?>
                                <img src="<?php echo e($imagenUrl); ?>" 
                                     alt="<?php echo e($producto->nombre_comercial); ?>" class="w-100" style="height: 350px; object-fit: cover;">
                                <div class="product-badge">⭐ BESTSELLER</div>
                                <div class="product-overlay">
                                    <a href="<?php echo e(route('tienda.producto.detalle', $producto->id)); ?>" class="btn btn-light btn-lg rounded-circle shadow-lg">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="p-4">
                                <div class="mb-2">
                                    <small class="text-muted"><?php echo e($producto->estilo?->nombre ?? 'Estilo'); ?></small>
                                </div>
                                <h5 class="fw-bold mb-3"><?php echo e($producto->nombre_comercial); ?></h5>
                                ...
                                <div class="mb-3 pb-3 border-bottom">
                                    <p class="text-muted small mb-0"><?php echo e(Str::limit($producto->descripcion, 60)); ?></p>
                                </div>

                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div>
                                        <p class="text-primary fw-bold fs-5 mb-1">
                                            $<?php echo e(number_format($producto->variantes->first()?->precio_minorista ?? 0, 0, ',', '.')); ?> COP
                                        </p>
                                        <?php if(auth()->check() && auth()->user()?->rol?->nombre === 'mayorista'): ?>
                                            <small class="text-success">Mayorista: $<?php echo e(number_format($producto->variantes->first()?->precio_mayorista ?? 0, 0, ',', '.')); ?></small>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <a href="<?php echo e(route('tienda.producto.detalle', $producto->id)); ?>" class="btn btn-dark w-100 rounded-pill fw-bold py-2 hover-lift">
                                    + Ver Detalles
                                </a>
                            </div>
                        </div>
            ...
            <div class="text-center mt-5">
                <a href="<?php echo e(route('tienda.catalogo')); ?>" class="btn btn-primary btn-lg px-5 rounded-pill fw-bold">
