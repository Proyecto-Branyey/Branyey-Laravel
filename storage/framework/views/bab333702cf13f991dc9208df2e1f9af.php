    ...
    <form action="<?php echo e(route('admin.usuarios.update', $usuario->id)); ?>" method="POST">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="ciudad_defecto" id="ciudad_defecto" class="form-control" value="<?php echo e(old('ciudad_defecto', $usuario->ciudad_defecto)); ?>">
            </div>
            <div class="col-md-6 mb-3">
                <label for="departamento_defecto" class="form-label">Departamento</label>
                <input type="text" name="departamento_defecto" id="departamento_defecto" class="form-control" value="<?php echo e(old('departamento_defecto', $usuario->departamento_defecto)); ?>">
            </div>
        </div>
        <div class="mb-3">
