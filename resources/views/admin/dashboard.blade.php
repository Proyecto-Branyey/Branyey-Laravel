        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('admin.ventas.index') }}" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver ventas">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('admin.ventas.index') }}" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver ingresos y ventas">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('admin.productos.index') }}" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver catálogo">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('admin.usuarios.index') }}" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver clientes y usuarios">
                        <div class="card border-0 shadow-lg rounded-4 p-4 position-relative overflow-hidden dashboard-card-gradient-info">
                            ...
                            <h2 class="fw-black mb-0">{{ $stats['clientes_count'] }}</h2>
                            <small class="text-muted d-block mt-1">Mayoristas: {{ $stats['mayoristas_count'] }} | Minoristas: {{ $stats['minoristas_count'] }}</small>
                        </div>
                    </a>
                </div>
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('admin.usuarios.index') }}" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver administradores">
                        <div class="card border-0 shadow-lg rounded-4 p-4 position-relative overflow-hidden dashboard-card-gradient-admin">
                            ...
                            <h2 class="fw-black mb-0">{{ $stats['admins_count'] }}</h2>
                        </div>
                    </a>
                </div>
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('admin.usuarios.papelera') }}" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver usuarios en papelera">
                        <div class="card border-0 shadow-lg rounded-4 p-4 position-relative overflow-hidden dashboard-card-gradient-trash">
                            ...
                            <h2 class="fw-black mb-0">{{ $stats['usuarios_papelera_count'] }}</h2>
