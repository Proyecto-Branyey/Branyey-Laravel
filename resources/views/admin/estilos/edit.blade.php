                    ...
                    <form action="{{ route('admin.estilos.update', $estilo->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="precio_base_minorista" class="form-control" min="0" step="0.01" value="{{ $estilo->precio_base_minorista }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Precio Mayorista ($)</label>
                                <input type="number" name="precio_base_mayorista" class="form-control" min="0" step="0.01" value="{{ $estilo->precio_base_mayorista }}" required>
                            </div>
                        </div>
