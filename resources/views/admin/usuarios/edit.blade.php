    ...
    <form action="{{ route('admin.usuarios.update', $usuario->id) }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="departamento_defecto" id="departamento_defecto" list="departamentos_list" class="form-control" value="{{ old('departamento_defecto', $usuario->departamento_defecto) }}">
                <datalist id="departamentos_list"></datalist>
            </div>
            <div class="col-md-6 mb-3">
                <label for="ciudad_defecto" class="form-label">Ciudad</label>
                <input type="text" name="ciudad_defecto" id="ciudad_defecto" list="ciudades_list" class="form-control" value="{{ old('ciudad_defecto', $usuario->ciudad_defecto) }}">
