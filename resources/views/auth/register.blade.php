...
@section('title', 'Registro - Branyey')
                            ...
                            <div class="col-md-6">
                                <div class="form-group-register">
                                    ...
                                    <input type="text" name="nombre_completo" 
                                           class="register-input @error('nombre_completo') is-invalid @enderror" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group-register">
                                    ...
                                    <input type="text" name="username" 
                                           class="register-input @error('username') is-invalid @enderror" 
                                           value="{{ old('username') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group-register">
                                    ...
                                    <input type="tel" name="telefono" id="telefono"
                                           class="register-input @error('telefono') is-invalid @enderror" 
                                           value="{{ old('telefono') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group-register">
                                    ...
                                    <input type="text" name="direccion_defecto" 
                                           class="register-input @error('direccion_defecto') is-invalid @enderror" 
                                           value="{{ old('direccion_defecto') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group-register">
                                    ...
                                    <input type="text" name="departamento_defecto" id="departamento_defecto"
                                           ...
                                           class="register-input location-input @error('departamento_defecto') is-invalid @enderror" 
                                           value="{{ old('departamento_defecto') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group-register">
                                    ...
                                    <input type="text" name="ciudad_defecto" id="ciudad_defecto"
                                           list="ciudades_list" 
                                           class="register-input location-input @error('ciudad_defecto') is-invalid @enderror" 
                                           value="{{ old('ciudad_defecto') }}" 
