                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.clientes.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="direccion_defecto" class="form-control" value="{{ old('direccion_defecto') }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Ciudad</label>
                            <input type="text" name="ciudad_defecto" class="form-control" value="{{ old('ciudad_defecto') }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Departamento</label>
                            <input type="text" name="departamento_defecto" class="form-control" value="{{ old('departamento_defecto') }}">
                        </div>
                        <div class="mb-3">
