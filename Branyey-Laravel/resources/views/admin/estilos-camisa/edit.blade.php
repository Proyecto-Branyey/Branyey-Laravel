    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="fw-bold mb-1 text-dark">
                <i class="bi bi-pencil-square me-2 text-secondary"></i>Editar Estilo
            </h1>
            <p class="text-muted small mb-0">Modifica la información del estilo de camisa</p>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.estilos-camisa.update', $estilos_camisa->id) }}" method="POST" id="estiloForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nombre" id="nombre" class="form-control rounded-3" 
                                   value="{{ old('nombre', $estilos_camisa->nombre) }}" 
                        ...
                        <div class="mb-4 p-3 bg-light rounded-3">
                            <div class="d-flex align-items-center gap-2 mb-2">
                                ...
                                <span class="small text-muted">Información del registro</span>
                            </div>
                            <div class="row small">
                                <div class="col-6">
                                    <span class="text-muted">ID:</span>
                                    <span class="fw-semibold">#{{ $estilos_camisa->id }}</span>
                                </div>
                                <div class="col-6">
                                    <span class="text-muted">Creado:</span>
                                    <span class="fw-semibold">{{ $estilos_camisa->created_at->format('d/m/Y H:i') }}</span>
                                </div>
                            </div>
                        </div>
