    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="fw-bold mb-1 text-dark">
                <i class="bi bi-trash3-fill me-2 text-secondary"></i>Papelera de Tallas
            </h1>
            <p class="text-muted small mb-0">Tallas desactivadas que pueden ser reactivadas</p>
        </div>
        ...
        <div class="card-header bg-white py-3 border-bottom">
            <div class="d-flex justify-content-between align-items-center">
                <span class="text-muted small text-uppercase fw-semibold">
                    <i class="bi bi-trash3 me-1"></i> Listado de tallas inactivas
                </span>
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <form action="{{ route('admin.tallas.activar', $talla->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" class="btn btn-sm btn-outline-success" onclick="return confirm('¿Reactivar esta talla?')" title="Reactivar">
