...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Modifica la información del producto #<?php echo e($producto->id); ?></p>
        </div>
    ...
    <div class="form-card">
        <form action="<?php echo e(route('admin.productos.update', $producto)); ?>" method="POST" enctype="multipart/form-data" id="productForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre_comercial" class="form-input" 
                                   value="<?php echo e(old('nombre_comercial', $producto->nombre_comercial)); ?>" required>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="estilo_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $estilos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estilo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($estilo->id); ?>" <?php echo e(old('estilo_id', $producto->estilo_id) == $estilo->id ? 'selected' : ''); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select name="clasificacion_id" id="clasificacion_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $clasificaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clasif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($clasif->id); ?>" <?php echo e(old('clasificacion_id', $producto->clasificacion_id) == $clasif->id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="descripcion" class="form-input" rows="3"><?php echo e(old('descripcion', $producto->descripcion)); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div id="variants-container">
                    ...
                    <div class="variant-card" data-variant-id="<?php echo e($variante->id); ?>">
                        <div class="variant-header">
                            <span class="variant-number">Variante #<?php echo e($index + 1); ?></span>
                            <button type="button" class="btn-remove-variant" <?php echo e($loop->first ? 'disabled style="opacity: 0.5;"' : ''); ?>>
                        ...
                        <div class="row g-3">
                            <div class="col-md-2">
                                ...
                                <select name="variantes[<?php echo e($index); ?>][talla_id]" class="form-input talla-select" required>
                                    ...
                                    <?php $__currentLoopData = $tallas->where('clasificacion_id', $producto->clasificacion_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $talla): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($talla->id); ?>" <?php echo e($variante->talla_id == $talla->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="variantes[<?php echo e($index); ?>][color_id]" class="form-input color-select" required>
                                    ...
                                    <?php $__currentLoopData = $colores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($color->id); ?>" <?php echo e($variante->colores->first()?->id == $color->id ? 'selected' : ''); ?>>
                                            <?php echo e(ucfirst($color->nombre)); ?>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" name="variantes[<?php echo e($index); ?>][precio_minorista]" class="form-input" 
                                       step="0.01" min="0" value="<?php echo e($variante->precio_minorista); ?>" required>
                            </div>
                            <div class="col-md-2">
                                <label class="variant-label text-warning">Precio mayorista</label>
                                <input type="number" name="variantes[<?php echo e($index); ?>][precio_mayorista]" class="form-input" 
                                       step="0.01" min="0" value="<?php echo e($variante->precio_mayorista); ?>" required>
                            </div>
                            <div class="col-md-1">
                                <label class="variant-label text-info">Stock</label>
                                <input type="number" name="variantes[<?php echo e($index); ?>][stock]" class="form-input" 
                                       min="0" value="<?php echo e($variante->stock); ?>" required>
                            </div>
                            <div class="col-md-2">
                                <label class="variant-label">Fotografía</label>
                                <div class="file-input-wrapper">
                                    <input type="file" name="variantes[<?php echo e($index); ?>][foto]" class="form-input foto-input" accept="image/*">
                                ...
                                <?php if($imagenColor): ?>
                                    <div class="foto-preview mt-2">
                                        ...
                                        <a href="<?php echo e(Storage::url($imagenColor->url)); ?>" target="_blank" class="foto-link">Ver imagen</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\Branyeygit\Branyey-Laravel\resources\views/admin/productos/edit.blade.php ENDPATH**/ ?>