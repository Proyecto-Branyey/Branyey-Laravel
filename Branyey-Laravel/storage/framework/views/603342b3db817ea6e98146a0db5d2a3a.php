                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <?php else: ?>
                        ...
                        <?php if(!auth()->check() || auth()->user()?->rol?->nombre !== 'administrador'): ?>
                            <li class="nav-item ms-lg-3">
                                <a class="cart-nav-simple" href="<?php echo e(route('tienda.cart.index')); ?>" title="Carrito">
                                    <i class="bi bi-bag-fill"></i>
                                    <?php $count = session('cart') ? count(session('cart')) : 0; ?>
                                    <?php if($count > 0): ?>
                                        <span class="cart-nav-badge"><?php echo e($count); ?></span>
                                    <?php endif; ?>
                                </a>
                            </li>
                        <?php endif; ?>
...
<?php endif; ?>
    <?php if(!auth()->check() || auth()->user()?->rol?->nombre !== 'administrador'): ?>
        ...
        <?php if($cartCount > 0): ?>
            <a href="<?php echo e(route('tienda.cart.index')); ?>" class="cart-float show" id="cartFloat">
                <div class="cart-float-icon">
                    <i class="bi bi-bag-fill"></i>
                    <span class="cart-float-badge"><?php echo e($cartCount); ?></span>
                </div>
                <div class="cart-float-text">
                    <small>Ver carrito</small>
                    <strong>$<?php echo e(number_format(session('cart_total', 0), 0, ',', '.')); ?></strong>
                </div>
            </a>
        <?php endif; ?>
    <?php endif; ?>
...
</html><?php /**PATH C:\Users\USER\Documents\Branyeygit\Branyey-Laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>