...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('admin.tallas.index')); ?>" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('admin.tallas.store')); ?>" method="POST" id="tallaForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="d-flex gap-2 pt-3 border-top">
                            ...
                            <a href="<?php echo e(route('admin.tallas.index')); ?>" class="btn btn-outline-secondary px-4">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\Branyeygit\Branyey-Laravel\resources\views/admin/tallas/create.blade.php ENDPATH**/ ?>