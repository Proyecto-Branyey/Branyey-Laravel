...
<div class="bg-white py-5">
    <div class="container">
        ...
        <div class="mb-4">
            <a href="<?php echo e(route('tienda.catalogo')); ?>" class="btn-back">
                ...
                <div class="product-gallery">
                    ...
                    <div class="main-image-container">
                        <img id="main-product-image" 
                             ...
                             alt="<?php echo e($producto->nombre_comercial); ?>"
                             class="main-product-image">
                    </div>

                    <?php if($producto->variantes->flatMap->colores->unique('id')->count() > 1): ?>
                            ...
                            <?php $__currentLoopData = $producto->variantes->flatMap->colores->unique('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($imagenColor): ?>
                                    <div class="thumbnail-item <?php echo e($loop->first ? 'active' : ''); ?>"
                                         onclick="changeMainImage(this, '<?php echo e(Storage::url($imagenColor->url)); ?>', <?php echo e($color->id); ?>)">
                                        <img src="<?php echo e(Storage::url($imagenColor->url)); ?>" 
                                             alt="<?php echo e($color->nombre); ?>"
            ...
            <div class="col-lg-5">
                <div class="product-info">
                    <div class="product-header">
                        ...
                        <h1 class="product-title"><?php echo e($producto->nombre_comercial); ?></h1>
                        <p class="product-reference">REF: <?php echo e($producto->estilo?->nombre ?? ''); ?>-<?php echo e($producto->id); ?></p>
                        ...
                        <?php if($producto->descripcion): ?>
                            <div class="product-description mt-3">
                                ...
                                <p class="description-text"><?php echo e($producto->descripcion); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                            ...
                            <div class="color-options">
                                <?php $__currentLoopData = $producto->variantes->flatMap->colores->unique('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="color-option-wrapper">
                                        <input type="radio" name="color_id" id="color-<?php echo e($color->id); ?>" 
                                               value="<?php echo e($color->id); ?>" 
                                               class="color-input"
                                               data-color-id="<?php echo e($color->id); ?>"
                                               data-color-name="<?php echo e($color->nombre); ?>">
                                        <label for="color-<?php echo e($color->id); ?>" 
                                               class="color-label"
                                               style="background-color: <?php echo e($color->codigo_hex ?? '#000000'); ?>;"
                                               title="<?php echo e($color->nombre); ?>">
                                            <span class="color-tooltip"><?php echo e($color->nombre); ?></span>
                                        </label>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            ...
                            <div class="size-options" id="tallas-container">
                                <?php $__currentLoopData = $producto->variantes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $__currentLoopData = $v->colores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="size-option-wrapper d-none color-group-<?php echo e($color->id); ?>">
                                            <input type="radio" name="variante_id" id="size-<?php echo e($v->id); ?>" 
                                                   value="<?php echo e($v->id); ?>" 
                                                   class="size-input"
                                                   data-precio="$<?php echo e(number_format($v->getPrecioActual(), 0, ',', '.')); ?> COP"
                                                   data-stock="<?php echo e($v->stock); ?>">
                                            <label for="size-<?php echo e($v->id); ?>" class="size-label">
                                                <?php echo e($v->talla?->nombre ?? 'Única'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\Branyeygit\Branyey-Laravel\resources\views/tienda/producto_detalle.blade.php ENDPATH**/ ?>