<section>
    ...
    <form method="post" action="<?php echo e(route('profile.update')); ?>" id="profileForm" class="profile-info-form">
        <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <div class="invalid-feedback-profile">⚠️ <?php echo e($message); ?></div>
                    <?php unset($message);
            ...
            <div class="col-md-6">
                <div class="form-group-profile">
                    ...
                    <input id="nombre_completo" name="nombre_completo" type="text" 
                           class="profile-input profile-editable" 
                           value="<?php echo e(old('nombre_completo', $user->nombre_completo)); ?>" 
            ...
            <div class="col-12">
                <div class="form-group-profile">
                    ...
                    <input id="direccion_defecto" name="direccion_defecto" type="text" 
                           class="profile-input profile-editable" 
                           value="<?php echo e(old('direccion_defecto', $user->direccion_defecto)); ?>" 
            ...
            <div class="col-md-6">
                <div class="form-group-profile">
                    ...
                    <input type="text" name="departamento_defecto" id="departamento_defecto" 
                           ...
                           value="<?php echo e(old('departamento_defecto', $user->departamento_defecto)); ?>" 
            ...
            <div class="col-md-6">
                <div class="form-group-profile">
                    ...
                    <input type="text" name="ciudad_defecto" id="ciudad_defecto" 
                           list="ciudades_list" 
                           class="profile-input profile-editable location-input" 
                           value="<?php echo e(old('ciudad_defecto', $user->ciudad_defecto)); ?>" 
                           autocomplete="off" disabled>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const loadCitiesByDepartmentName = async () => {
        ...
        try {
            ...
            const savedCity = "<?php echo e(old('ciudad_defecto', $user->ciudad_defecto)); ?>";
    ...
    const loadDepartments = async () => {
        try {
            ...
            const savedDept = "<?php echo e(old('departamento_defecto', $user->departamento_defecto)); ?>";
...
</script><?php /**PATH C:\Users\USER\Documents\Branyeygit\Branyey-Laravel\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>