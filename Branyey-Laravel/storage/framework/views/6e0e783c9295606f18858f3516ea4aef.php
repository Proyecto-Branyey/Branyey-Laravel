            ...
            <div class="row justify-content-center mt-4">
                <div class="col-md-8">
                    <div class="bg-white rounded-4 shadow-sm p-4 border-0 text-center" style="border-top: 4px solid #e3342f;">
                        ...
                        <a href="<?php echo e(route('profile.datos.pdf')); ?>" class="btn btn-outline-primary mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\Branyeygit\resources\views/profile/edit.blade.php ENDPATH**/ ?>