        ...
        <nav class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse min-vh-100 shadow">
            <div class="position-sticky pt-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link text-white active mb-2" href="<?php echo e(route('admin.dashboard')); ?>">
                            <i class="bi bi-speedometer2 me-2"></i> Dashboard
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo e(route('admin.ventas.index')); ?>">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="menuProductos">
                            <ul class="nav flex-column ms-3 mt-1">
                                <li class="nav-item">
                                    <a class="nav-link text-secondary py-1" href="<?php echo e(route('admin.productos.index')); ?>">
                                        <i class="bi bi-list-ul me-2"></i> Ver Inventario
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-success py-1" href="<?php echo e(route('admin.productos.create')); ?>">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="menuUsuarios">
                            <ul class="nav flex-column ms-3 mt-1">
                                <li class="nav-item">
                                    <a class="nav-link text-secondary py-1" href="<?php echo e(route('admin.usuarios.index')); ?>">
                                        <i class="bi bi-list-ul me-2"></i> Ver Usuarios
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-success py-1" href="<?php echo e(route('admin.usuarios.create')); ?>">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="menuCatalogos">
                            <ul class="nav flex-column ms-3 mt-1">
                                <li class="nav-item">
                                    <a class="nav-link text-secondary py-1" href="<?php echo e(route('admin.tallas.index')); ?>">
                                        <i class="bi bi-rulers me-2"></i> Tallas
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-secondary py-1" href="<?php echo e(route('admin.colores.index')); ?>">
                                        <i class="bi bi-palette me-2"></i> Colores
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-secondary py-1" href="<?php echo e(route('admin.estilos-camisa.index')); ?>">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6 col-lg-3">
                    <a href="<?php echo e(route('admin.ventas.index')); ?>" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver ventas">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="<?php echo e(route('admin.ventas.index')); ?>" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver ingresos y ventas">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="<?php echo e(route('admin.productos.index')); ?>" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver catálogo">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="<?php echo e(route('admin.usuarios.index')); ?>" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver clientes y usuarios">
                        <div class="card border-0 shadow-lg rounded-4 p-4 position-relative overflow-hidden dashboard-card-gradient-info">
                            ...
                            <h2 class="fw-black mb-0"><?php echo e($stats['clientes_count']); ?></h2>
                            <small class="text-muted d-block mt-1">Mayoristas: <?php echo e($stats['mayoristas_count']); ?> | Minoristas: <?php echo e($stats['minoristas_count']); ?></small>
                        </div>
                    </a>
                </div>
                <div class="col-md-6 col-lg-3">
                    <a href="<?php echo e(route('admin.usuarios.index')); ?>" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver administradores">
                        <div class="card border-0 shadow-lg rounded-4 p-4 position-relative overflow-hidden dashboard-card-gradient-admin">
                            ...
                            <h2 class="fw-black mb-0"><?php echo e($stats['admins_count']); ?></h2>
                        </div>
                    </a>
                </div>
                <div class="col-md-6 col-lg-3">
                    <a href="<?php echo e(route('admin.usuarios.papelera')); ?>" class="text-decoration-none text-reset d-block dashboard-card-link" title="Ver usuarios en papelera">
                        <div class="card border-0 shadow-lg rounded-4 p-4 position-relative overflow-hidden dashboard-card-gradient-trash">
                            ...
                            <h2 class="fw-black mb-0"><?php echo e($stats['usuarios_papelera_count']); ?></h2>
            ...
            <style>
                ...
                .dashboard-card-link .card { transition: transform 0.2s ease, box-shadow 0.2s ease; }
                .dashboard-card-link:hover .card { transform: translateY(-2px); box-shadow: 0 .75rem 1.5rem rgba(220, 53, 69, .2) !important; }
                hr { opacity: 0.2; }
            </style>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\Branyeygit\Branyey-Laravel\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>