...
<head>
    ...
    <title>Branyey Admin - <?php echo $__env->yieldContent('title', 'Panel de Control'); ?></title>
...
<body>
    ...
    <nav class="navbar-admin navbar navbar-expand-lg navbar-dark sticky-top shadow-sm">
        <div class="container-fluid px-4">
            <a class="navbar-brand" href="<?php echo e(route('admin.dashboard')); ?>">BRANYEY ADMIN</a>
    ...
    <?php echo $__env->yieldContent('admin-layout'); ?>

    
    <footer class="footer-admin text-center">
        <div class="container-fluid px-4">
            <p class="mb-0">© <?php echo e(date('Y')); ?> Branyey - Panel de Administración</p>
        </div>
    </footer>
...
</html><?php /**PATH C:\Users\USER\Documents\Branyeygit\Branyey-Laravel\resources\views/layouts/admin_base.blade.php ENDPATH**/ ?>