                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5 bg-white">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="telefono_checkout" name="telefono" class="form-control form-control-lg rounded-pill <?php $__errorArgs = ['telefono'];
...
unset($__errorArgs, $__bag); ?>" 
                                value="<?php echo e(old('telefono', $user->telefono ?? '')); ?>" placeholder="Ej: 300 123 4567" required readonly>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="departamento" id="departamento_checkout" list="departamentos_list_checkout" class="form-control form-control-lg rounded-pill" 
                                value="<?php echo e(old('departamento', $user->departamento_defecto ?? 'Cundinamarca')); ?>" required readonly>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="ciudad" id="ciudad_checkout" list="ciudades_list_checkout" class="form-control form-control-lg rounded-pill" 
                                value="<?php echo e(old('ciudad', $user->ciudad_defecto ?? 'Bogotá')); ?>" required readonly>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" id="direccion_checkout" name="direccion" class="form-control form-control-lg rounded-pill <?php $__errorArgs = ['direccion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                value="<?php echo e(old('direccion', $user->direccion_defecto ?? '')); ?>" placeholder="Calle, Carrera, Conjunto, Apto..." required readonly>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\Branyeygit\Branyey-Laravel\resources\views/tienda/checkout.blade.php ENDPATH**/ ?>