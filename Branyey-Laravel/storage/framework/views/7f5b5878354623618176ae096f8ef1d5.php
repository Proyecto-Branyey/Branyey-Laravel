<section>
    ...
    <form method="post" action="<?php echo e(route('password.update')); ?>" class="update-password-form">
        <?php echo csrf_field(); ?>
                ...
                <div class="form-group-password">
                    ...
                    <div class="input-wrapper-password">
                        <input id="update_password_current_password" 
                               ...
                               type="password" 
                               class="password-input <?php $__errorArgs = ['current_password', 'updatePassword'];
                ...
                <div class="form-group-password">
                    ...
                    <div class="input-wrapper-password">
                        <input id="update_password_password" 
                               name="password" 
                               type="password" 
                               class="password-input <?php $__errorArgs = ['password', 'updatePassword'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</script><?php /**PATH C:\Users\USER\Documents\Branyeygit\Branyey-Laravel\resources\views/profile/partials/update-password-form.blade.php ENDPATH**/ ?>