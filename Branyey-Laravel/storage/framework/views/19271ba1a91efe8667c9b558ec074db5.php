        ...
        <div class="row align-items-center h-100" style="min-height: 80vh;">
            ...
            <div class="col-lg-6 d-none d-lg-flex justify-content-end align-items-center position-relative">
                <div class="hero-image-container">
                    <img src="<?php echo e(asset('images/fondo.png')); ?>"
...
<section class="py-5 bg-white">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="<?php echo e(asset('images/fondo2.png')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\Branyeygit\Branyey-Laravel\resources\views/tienda/inicio.blade.php ENDPATH**/ ?>